  ...
  return (
    <div style={{ animation: 'fadeIn 0.5s ease-in' }}>
      ...
      <div className="page-hero" style={{ minHeight: '45vh', backgroundImage: 'linear-gradient(rgba(10, 25, 47, 0.7), rgba(10, 25, 47, 0.8))' }}>
        <h1 style={{ fontSize: '3.5rem', marginBottom: '1rem', color: 'white' }}>Sliding Deck Covers</h1>
        <p style={{ fontSize: '1.2rem', color: '#ccc', maxWidth: '700px' }}>
          Fluid architectural movement. Glide your terrace effortlessly over the water to reclaim your outdoor living space.
        </p>
      </div>
