...
<section className="relative h-[700px] overflow-hidden">
  <Image
    src="/pools/folding/fold3-1.png"
    alt="ApertoLux Sliding Deck Cover"
    fill
    priority
  ...
  <div className="absolute inset-0 flex items-center justify-center px-6">
    <div className="z-10 flex flex-col items-center justify-center text-center text-white gap-6 max-w-4xl">
      <h1 className="text-5xl md:text-7xl font-bold leading-none m-0">
        Sliding Deck Covers
      </h1>

      <p className="text-xl md:text-2xl leading-relaxed m-0 max-w-2xl">
        One click to unlock quality life. Transform your swimming pool into a
        solid, load-bearing entertainment space in seconds.
      </p>
    </div>
  </div>
</section>
      ...
      <div className="container" style={{ marginTop: '-4rem', position: 'relative', zIndex: 10, paddingBottom: '4rem' }}>
        ...
        <div className="feature-section" style={{ paddingTop: '2rem', borderBottom: 'none' }}>
          <div className="feature-image-placeholder" style={{ height: '450px' }}>
            <Image src="/pools/folding/fold1.png" alt="Folding Deck Load Bearing" style={{ width: '100%', height: '100%', objectFit: 'cover', borderRadius: '4px' }} width={800} height={450} ></Image>
          </div>
        ...
        <div className="feature-section" style={{ borderBottom: 'none', flexDirection: 'row-reverse' }}>
          <div className="feature-image-placeholder" style={{ height: '450px', backgroundColor: 'var(--navy-light)' }}>
                        <Image src="/pools/folding/fold3-1.png" alt="Folding Deck Load Bearing" style={{ width: '100%', height: '100%', objectFit: 'cover', borderRadius: '4px' }} width={800} height={450} ></Image>
        ...
        <div className="feature-section" style={{ borderBottom: 'none' }}>
          <div className="feature-image-placeholder" style={{ height: '450px' }}>
                        <Image src="/pools/folding/fold4.png" alt="Folding Deck Load Bearing" width={800} height={450} style={{ width: '100%', height: '100%', objectFit: 'cover', borderRadius: '4px' }}  ></Image>
